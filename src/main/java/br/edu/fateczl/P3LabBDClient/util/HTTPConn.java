package br.edu.fateczl.P3LabBDClient.util;
...
public class HTTPConn {
	...
	public String getOp(String httpUrl, String urlComp, String urlComp2) throws MalformedURLException, IOException, ProtocolException {
